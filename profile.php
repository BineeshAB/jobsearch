	...
	<body>
		...
		<div class="content">
			<div class="profiledesign">
				...
				<center><pre><button name="print" id="print" class="btn" onclick="pscreen()">Print</button>     <button name="logout" id="logout" class="btn" onclick="logoutpage()">LOG OUT</button></pre></center>
			</div>
